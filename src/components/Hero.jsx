  ...
  return (
    <div name="home" className="w-full h-screen bg-[#B6BBC4]">
      ...
      <div className="max-w-[1000px] mx-auto px-8 flex flex-col justify-center h-full">
        <p className="text-[#31304D] font-bold">Hi, my name is</p>
        <h1 className="text-5xl sm:text-7xl font-extrabold text-[#161A30]">
          Anthony Kahly
        </h1>
        <h2 className="text-4xl sm:text-7xl font-bold text-[#31304D]">
          Full Stack Web Developer.
        </h2>
        <p className="text-[#4f4d81] py-4 max-w-[700px] font-bold">
