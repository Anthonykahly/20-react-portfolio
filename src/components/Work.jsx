...
{/*Card container*/}
        <div className="grid sm:grid-cols-2 md:grid-cols-3 gap-4">
          ...
          {/*Project*/}
          <div style={{backgroundImage: `url(${chatstrology})`}}
            ...
            <div className="opacity-0 group-hover:opacity-100">
              ...
              <div className="pt-8 text-center">
                <a href="https://github.com/GameCatCam/Astrology-Board">
                  <button className="text-center rounded-lg px-4 py-3 m-2 bg-white text-gray-900 font-extrabold text-lg">GITHUB</button>
                </a>
              </div>
            </div>
          </div>
          ...
          {/*Project 4*/}
          <div style={{backgroundImage: `url(${readmegen})`}}
          className="shadow-lg shadow-[#333333] group container rounded-md flex justify-center items-center content-div">
          ...
          {/*Project 5*/}
          <div style={{backgroundImage: `url(${workdayplanner})`}}
          className="shadow-lg shadow-[#333333] group container rounded-md flex justify-center items-center content-div">
          ...
          {/*Project 6*/}
          <div style={{backgroundImage: `url(${horiseonrefractor})`}}
          className="shadow-lg shadow-[#333333] group container rounded-md flex justify-center items-center content-div">
